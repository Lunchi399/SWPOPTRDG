...
SECRET_KEY = 'django-insecure-b#lih**1n2qmr3adjc!zi@1!+-7@a=uw-e^fp5x#7)sd5rw)$%'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # Reemplaza el JWTAuthentication por el personalizado
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME':  timedelta(hours=8),  # duración de un turno
